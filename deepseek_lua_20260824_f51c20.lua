--[[
    Abacaxi Hub Source - Cak Thai Dúi
...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Graihub/Uigay/refs/heads/main/Redui"))():MakeWindow({
    Title = "BaMia Hub",
    SubTitle = "By BelBel",
...
imageButton.Image = "rbxassetid://85288799798332"
...
uiStroke.Color = Color3.fromRGB(204, 153, 102)
...
Status:AddDiscordInvite({
    Name = "Server Discord Bamia Hub",
    Description = "join for Update <3",
    Logo = "rbxassetid://85288799798332",
    Invite = "https://discord.gg/qVa6jedW9p"
})
...
if game.PlaceId == 7449423635 or game.PlaceId == 100117331123089 then
    ...
    Event:AddToggle({
        ...
        Callback = function(I)
            _G.FrozenTP = I            _G.SaveData["FrozenTP_Save"] = I
                                    ...
                                    repeat
                                        ...
                                        if plr:DistanceFromCharacter(layer.CFrame.Position) <= 200 then
                                            ...
                                            if Uses kils then
                                                ...
                                                Uses kils("Melee", "X")
                                                Uses kils("Melee", "C")
                                                Uses kils("Blox Fruit", "Z")
                                                Uses kils("Blox Fruit", "X")
                                                Uses kils("Blox Fruit", "C")
                                            end
                                        end
...
Esp:AddToggle({Name = "Esp Chests", Default = false, Callback = function(I)
    ChestESP = I    spawn(function() while ChestESP do wait(1); ChestEsp() end end)
end})
