...
task.spawn(function()
    if getGlobalEnv().Configs and getGlobalEnv().Configs['FPS Booster'] then
        local effect = L_1_[7]:FindFirstChild('Effect')
        if effect then
            effect:Destroy()
        end
...
task.wait(2)
task.spawn(function()
    if getGlobalEnv().Configs['FPS Booster'] then
        local L_5_ = {}
...
L_1_[42].Name = 'MainFrame'
L_1_[42].Size = UDim2.new(0, 250, 0, 70)
L_1_[42].Position = UDim2.new(0.5, 0, 0, 15)
L_1_[42].AnchorPoint = Vector2.new(0.5, 0)
...
local turtle = Instance.new('ImageLabel')

turtle.Name = 'TurtleIcon'
turtle.Size = UDim2.new(0, 24, 0, 24)
...
TurtleCorner.CornerRadius = UDim.new(1, 0)
TurtleCorner.Parent = turtle
L_1_[15] = Instance.new('TextLabel')
L_1_[15].Size = UDim2.new(1, 0, 0, 18)
...
L_1_[26].Size = UDim2.new(1, -10, 0, 16)
L_1_[26].Position = UDim2.new(0.5, 0, 0.55, 0)
...
task.spawn(function()
    while task.wait() do
        ...
        local L_NEW_TWEEN = L_1_[6]:Create(L_1_[12], TweenInfo.new(1.2), {
            Color = Color3.fromRGB(255, 165, 0),
        })
        local L_NEW_TEXT_TWEEN = L_1_[6]:Create(L_1_[15], TweenInfo.new(1.2), {
            TextColor3 = Color3.fromRGB(255, 165, 0),
        })
...
function CheckLevel2()
    ...
    Next_Level_X = Next_Level_X or 0
...
function TPZ(L_30_arg0)
    if not L_30_arg0 or typeof(L_30_arg0) ~= 'CFrame' then
        return
    end
    ...
    L_31_[2] = L_30_arg0
    L_31_[1] = (L_31_[2].Position - root.Position).Magnitude
    ...
    L_1_[23] = (game:GetService('TweenService')):Create(root, TweenInfo.new(L_31_[1] / L_31_[4], Enum.EasingStyle.Linear), {
        CFrame = L_31_[2],
    })
        ...
        elseif L_60_[3] == 'HopLowServer' then
            return function(L_123_arg0)
                ...
                pcall(function()
                    ...
                    if not getGlobalEnv().Loaded then
                        local L_131_ = {}
                            ...
                            if L_158_[3].Health > 0 and (L_158_[2].Position - L_154_[2].Position).Magnitude <= 350 then
                                ...
                                for L_160_forvar0, L_161_forvar1 in pairs(game.Workspace.Enemies:GetChildren())do
                                    ...
                                    if L_162_[2] ~= L_157_[3] and (L_162_[2]:IsA('Model') and (L_162_[2].Name == L_153_[2] and L_162_[2]:FindFirstChild('HumanoidRootPart'))) then
                                        L_159_[2] = L_162_[2]:FindFirstChild('HumanoidRootPart') or L_162_[2]:FindFirstChildWhichIsA('BasePart')
...
getGlobalEnv()['Fast Attack'] = true
L_1_[20] = 0

task.spawn(function()
    while task.wait(L_1_[20]) do
        if getGlobalEnv()['Fast Attack'] and not Stop_Fast_Attack then
                ...
                for L_199_forvar0, L_200_forvar1 in pairs(L_1_[40]:GetChildren())do
                    ...
                    if L_201_[3].Name == 'Cake Prince' and L_201_[3].Humanoid.Health > 0 then
                        repeat
                            ...
                            L_1_[14]()
                        until not L_201_[3].Parent or L_201_[3].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm
                    end
                end
                ...
                for L_202_forvar0, L_203_forvar1 in pairs(L_1_[7]:GetChildren())do
                    ...
                    if L_204_[3].Name == 'Cake Prince' and L_204_[3].Humanoid.Health > 0 then
                        repeat
                            ...
                            L_1_[14]()
                        until not L_204_[3].Parent or L_204_[3].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm
                    end
                end
            end
        end
                ...
                for L_257_forvar0, L_258_forvar1 in pairs(L_1_[40]:GetChildren())do
                    ...
                    if L_259_[1].Name == 'Darkbeard' and L_259_[1].Humanoid.Health > 0 then
                        repeat
                            ...
                            L_1_[14]()
                        until not L_259_[1].Parent or L_259_[1].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm
                    end
                end
                ...
                for L_260_forvar0, L_261_forvar1 in pairs(L_1_[7]:GetChildren())do
                    ...
                    if L_262_[1].Name == 'Darkbeard' and L_262_[1].Humanoid.Health > 0 then
                        repeat
                            ...
                            L_1_[14]()
                        until not L_262_[1].Parent or L_262_[1].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm
                    end
                end
            end
        end
                ...
                for L_263_forvar0, L_264_forvar1 in pairs(L_1_[40]:GetChildren())do
                    ...
                    if L_265_[2].Name == 'Core' and L_265_[2].Humanoid.Health > 0 then
                        repeat
                            ...
                            L_1_[14]()
                        until not L_265_[2].Parent or L_265_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm
                    end
                end
                ...
                for L_266_forvar0, L_267_forvar1 in pairs(L_1_[7]:GetChildren())do
                    ...
                    if L_268_[2].Name == 'Core' and L_268_[2].Humanoid.Health > 0 then
                        repeat
                            ...
                            L_1_[14]()
                        until not L_268_[2].Parent or L_268_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm
                    end
                end
            end
        end
    ...
    if L_1_[24].Value < 2650 or not Three_World then
        if L_1_[24].Value <= 9 and (not New_World and not Three_World) then
            if L_1_[35].PlayerGui.Main.Quest.Visible then
                        ...
                        for L_269_forvar0, L_270_forvar1 in pairs(L_1_[40]:GetChildren())do
                            ...
                            if L_271_[2].Name == Enemy and (L_1_[45].ffc(L_271_[2], 'Humanoid') and (L_271_[2].Humanoid.Health > 0 and L_1_[45].ffc(L_271_[2], 'HumanoidRootPart'))) then
                                repeat
                                    ...
                                    L_1_[14]()
                                until L_271_[2].Humanoid.Health <= 0 or not L_1_[40]:FindFirstChild(Enemy) or not (L_1_[35].PlayerGui.Main:FindFirstChild('Quest')).Visible or not getGlobalEnv().AutoFarm or Quest ~= nil
                            end
                        end
                    else
                ...
                until (L_1_[35].PlayerGui.Main:FindFirstChild('Quest')).Visible or not getGlobalEnv().AutoFarm or Quest ~= nil
            end
                ...
                if L_1_[45].ffc(L_1_[40], 'Shanda') then
                    for L_272_forvar0, L_273_forvar1 in pairs(L_1_[40]:GetChildren())do
                        ...
                        if L_274_[1].Name == 'Shanda' and (L_274_[1]:FindFirstChild('Humanoid') and L_274_[1].Humanoid.Health > 0) then
                            ...
                            until not L_274_[1].Parent or L_274_[1].Humanoid.Health <= 0 or L_1_[24].Value >= 91 or not getGlobalEnv().AutoFarm or Quest ~= nil
                        end
                    end
                else
...
if L_1_[24].Value >= 2000 and getGlobalEnv().Configs.Quest['RGB Haki'] then
                ...
                if ((L_1_[7]:WaitForChild('Remotes')):WaitForChild('CommF_')):InvokeServer('Cousin', 'Buy') == 1 then
                    ...
                    for L_313_forvar0, L_314_forvar1 in pairs(L_1_[19]:GetChildren())do
                        ...
                        if L_315_[3]:GetAttribute('OriginalName') ~= nil and (L_1_[45].sf(L_315_[3].Name, 'Fruit') and (L_315_[3]:IsA('Tool') and not L_1_[45].IsInList(L_1_[45].GetType(), L_315_[3]:GetAttribute('OriginalName')))) then
                            repeat
                                ...
                                L_1_[38]()
                            until not L_315_[3] or game.Players.LocalPlayer.Backpack:FindFirstChild(L_315_[3].Name) or L_1_[45].IsInList(L_1_[45].GetType(), L_315_[3]:GetAttribute('OriginalName')) or (L_315_[3].Handle.Position - L_1_[35].Character.HumanoidRootPart.Position).Magnitude <= 10 or not getGlobalEnv().AutoFarm
                        end
                    end
                    ...
                    if not L_312_[1] then
                        ...
                        if not L_1_[45].gi('Rengoku') and (L_1_[45].CheckBackpack('Hidden Key') and New_World) then
                            ...
                            until (L_1_[35].Character.HumanoidRootPart.Position - Vector3.new(6572.29248, 295.712677, -6966.09961)).Magnitude <= 5 or not getGlobalEnv().AutoFarm
                        ...
                        if New_World and (L_1_[45].IsHall() and L_1_[45].CheckBackpack('Library Key')) then
                            ...
                            until (L_1_[35].Character.HumanoidRootPart.Position - Vector3.new(6377.12549, 296.634735, -6843.76025)).Magnitude <= 1 or not L_1_[45].IsHall() or not getGlobalEnv().AutoFarm
                        ...
                        if L_1_[24].Value >= 2000 and (getGlobalEnv().Configs.Quest['RGB Haki'] and not RGB_Haki_H) then
                        ...
                        for L_442_forvar0, L_443_forvar1 in pairs(L_1_[40]:GetChildren())do
                            ...
                            if L_444_[2].Name == 'Ice Admiral' and L_444_[2].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_444_[2].Parent or L_444_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or L_441_[1].KilledIceBoss
                        ...
                        for L_445_forvar0, L_446_forvar1 in pairs(L_1_[40]:GetChildren())do
                            ...
                            if L_447_[1].Name == 'Thunder God' and L_447_[1].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_447_[1].Parent or L_447_[1].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Thunder God')
                            end
                        end
                        ...
                        for L_448_forvar0, L_449_forvar1 in pairs(L_1_[7]:GetChildren())do
                            ...
                            if L_450_[3].Name == 'Thunder God' and L_450_[3].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_450_[3].Parent or L_450_[3].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Thunder God')
                            end
                        end
                    end
                        ...
                        for L_451_forvar0, L_452_forvar1 in pairs(L_1_[40]:GetChildren())do
                            ...
                            if L_453_[3].Name == 'The Saw' and L_453_[3].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_453_[3].Parent or L_453_[3].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('The Saw')
                            end
                        end
                        ...
                        for L_454_forvar0, L_455_forvar1 in pairs(L_1_[7]:GetChildren())do
                            ...
                            if L_456_[3].Name == 'The Saw' and L_456_[3].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_456_[3].Parent or L_456_[3].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('The Saw')
                            end
                        end
                    end
                        ...
                        for L_457_forvar0, L_458_forvar1 in pairs(L_1_[40]:GetChildren())do
                            ...
                            if L_459_[1].Name == 'Smoke Admiral' and L_459_[1].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_459_[1].Parent or L_459_[1].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Smoke Admiral')
                            end
                        end
                        ...
                        for L_460_forvar0, L_461_forvar1 in pairs(L_1_[7]:GetChildren())do
                            ...
                            if L_462_[2].Name == 'Smoke Admiral' and L_462_[2].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_462_[2].Parent or L_462_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Smoke Admiral')
                            end
                        end
                    end
                        ...
                        for L_463_forvar0, L_464_forvar1 in pairs(L_1_[40]:GetChildren())do
                            ...
                            if L_465_[1].Name == 'Chief Warden' and L_465_[1].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_465_[1].Parent or L_465_[1].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Chief Warden')
                            end
                        end
                        ...
                        for L_466_forvar0, L_467_forvar1 in pairs(L_1_[7]:GetChildren())do
                            ...
                            if L_468_[2].Name == 'Chief Warden' and L_468_[2].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_468_[2].Parent or L_468_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Chief Warden')
                            end
                        end
                    end
                until not L_1_[45].CheckBoss('The Saw')
                        ...
                        for L_469_forvar0, L_470_forvar1 in pairs(L_1_[40]:GetChildren())do
                            ...
                            if L_471_[2].Name == 'Magma Admiral' and L_471_[2].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_471_[2].Parent or L_471_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Magma Admiral')
                            end
                        end
                        ...
                        for L_472_forvar0, L_473_forvar1 in pairs(L_1_[7]:GetChildren())do
                            ...
                            if L_474_[3].Name == 'Magma Admiral' and L_474_[3].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_474_[3].Parent or L_474_[3].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Magma Admiral')
                            end
                        end
                    end
                        ...
                        for L_475_forvar0, L_476_forvar1 in pairs(L_1_[40]:GetChildren())do
                            ...
                            if L_477_[2].Name == 'Wysper' and L_477_[2].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_477_[2].Parent or L_477_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Wysper')
                            end
                        end
                        ...
                        for L_478_forvar0, L_479_forvar1 in pairs(L_1_[7]:GetChildren())do
                            ...
                            if L_480_[1].Name == 'Wysper' and L_480_[1].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_480_[1].Parent or L_480_[1].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Wysper')
                            end
                        end
                    end
                        ...
                        for L_481_forvar0, L_482_forvar1 in pairs(L_1_[40]:GetChildren())do
                            ...
                            if L_483_[3].Name == 'Captain Elephant' and L_483_[3].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_483_[3].Parent or L_483_[3].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Captain Elephant')
                            end
                        end
                        ...
                        for L_484_forvar0, L_485_forvar1 in pairs(L_1_[7]:GetChildren())do
                            ...
                            if L_486_[2].Name == 'Captain Elephant' and L_486_[2].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_486_[2].Parent or L_486_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Captain Elephant')
                            end
                        end
                    end
                until not L_1_[45].CheckBoss('Wysper')
                        ...
                        for L_487_forvar0, L_488_forvar1 in pairs(L_1_[40]:GetChildren())do
                            ...
                            if L_489_[1].Name == 'Orbitus' and L_489_[1].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_489_[1].Parent or L_489_[1].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Orbitus')
                            end
                        end
                        ...
                        for L_490_forvar0, L_491_forvar1 in pairs(L_1_[7]:GetChildren())do
                            ...
                            if L_492_[2].Name == 'Orbitus' and L_492_[2].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_492_[2].Parent or L_492_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Orbitus')
                            end
                        end
                    end
                        ...
                        for L_493_forvar0, L_494_forvar1 in pairs(L_1_[40]:GetChildren())do
                            ...
                            if L_495_[2].Name == 'Diamond' and L_495_[2].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_495_[2].Parent or L_495_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Diamond')
                            end
                        end
                        ...
                        for L_496_forvar0, L_497_forvar1 in pairs(L_1_[7]:GetChildren())do
                            ...
                            if L_498_[3].Name == 'Diamond' and L_498_[3].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_498_[3].Parent or L_498_[3].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Diamond')
                            end
                        end
                    end
                        ...
                        for L_499_forvar0, L_500_forvar1 in pairs(L_1_[40]:GetChildren())do
                            ...
                            if L_501_[2].Name == 'Awakened Ice Admiral' and L_501_[2].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_501_[2].Parent or L_501_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Awakened Ice Admiral')
                            end
                        end
                        ...
                        for L_502_forvar0, L_503_forvar1 in pairs(L_1_[7]:GetChildren())do
                            ...
                            if L_504_[2].Name == 'Awakened Ice Admiral' and L_504_[2].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_504_[2].Parent or L_504_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Awakened Ice Admiral')
                            end
                        end
                    end
                                ...
                                for L_506_forvar0, L_507_forvar1 in pairs(L_1_[40]:GetChildren())do
                                    ...
                                    if L_508_[2].Name == 'Swan Pirate' and L_508_[2].Humanoid.Health > 0 then
                                        ...
                                        repeat
                                            ...
                                            L_1_[14]()
                                        until (L_508_[2].HumanoidRootPart.Position - L_1_[35].Character.HumanoidRootPart.Position).Magnitude <= 50 or L_508_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm
                                    end
                                end
                            else
                            ...
                            for L_509_forvar0, L_510_forvar1 in pairs(L_1_[40]:GetChildren())do
                                ...
                                if L_511_[1].Name == 'Jeremy' then
                                    repeat
                                        ...
                                        L_1_[14]()
                                    until not L_511_[1].Parent or L_511_[1].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm
                                end
                            end
                            ...
                            for L_512_forvar0, L_513_forvar1 in pairs(L_1_[40]:GetChildren())do
                                ...
                                if L_514_[2].Name == 'Tide Keeper' and (L_514_[2]:FindFirstChild('Humanoid') and (L_514_[2]:FindFirstChild('Humanoid')).Health > 0) then
                                    repeat
                                        ...
                                        L_1_[14]()
                                    until not L_514_[2].Parent or L_514_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm
                                end
                            end
                            ...
                            for L_515_forvar0, L_516_forvar1 in pairs(L_1_[7]:GetChildren())do
                                ...
                                if L_517_[2].Name == 'Tide Keeper' and (L_517_[2]:FindFirstChild('Humanoid') and (L_517_[2]:FindFirstChild('Humanoid')).Health > 0) then
                                    repeat
                                        ...
                                        L_1_[14]()
                                    until not L_517_[2].Parent or L_517_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm
                                end
                            end
                        else
                            L_1_[35]:Kick('Hop')
                                ...
                                for L_518_forvar0, L_519_forvar1 in pairs(L_1_[40]:GetChildren())do
                                    ...
                                    if L_520_[1].Humanoid.Health > 0 and (L_520_[1].HumanoidRootPart.Position - Vector3.new(976.467651, 111.174057, 1229.1084)).Magnitude <= 800 then
                                        repeat
                                            ...
                                            L_1_[14]()
                                        until not L_520_[1].Parent or L_520_[1].Humanoid.Health <= 0 or L_1_[45].ffc(L_1_[35].Backpack, 'Flower 3') or L_1_[45].ffc(L_1_[35].Character, 'Flower 3') or not getGlobalEnv().AutoFarm
                                    end
                                end
                            else
                                L_1_[31](CFrame.new(976.467651, 111.174057, 1229.1084), 1.5)
                                            ...
                                            if L_1_[45].ffc(L_1_[40], 'Orbitus') then
                                                for L_521_forvar0, L_522_forvar1 in pairs(L_1_[40]:GetChildren())do
                                                    ...
                                                    if L_523_[1].Name == 'Orbitus' and L_523_[1].Humanoid.Health > 0 then
                                                        ...
                                                        until not L_523_[1].Parent or L_523_[1].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm
                                            ...
                                            if L_1_[45].ffc(L_1_[40], 'Jeremy') then
                                                for L_524_forvar0, L_525_forvar1 in pairs(L_1_[40]:GetChildren())do
                                                    ...
                                                    if L_526_[3].Name == 'Jeremy' and L_526_[3].Humanoid.Health > 0 then
                                                        ...
                                                        until not L_526_[3].Parent or L_526_[3].Humanoid.Health <= 0 or not L_526_[3]:FindFirstChild('HumanoidRootPart') or not getGlobalEnv().AutoFarm
                                            ...
                                            if L_1_[45].ffc(L_1_[40], 'Diamond') then
                                                for L_527_forvar0, L_528_forvar1 in pairs(L_1_[40]:GetChildren())do
                                                    ...
                                                    if L_529_[1].Name == 'Diamond' and L_529_[1].Humanoid.Health > 0 then
                                                        ...
                                                        until not L_529_[1].Parent or L_529_[1].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm
                        ...
                        if Quest_Start_Evo_Fishman_V3 then
                            ...
                            for L_531_forvar0, L_532_forvar1 in pairs(L_1_[19].SeaBeasts:GetChildren())do
                                ...
                                if L_533_[3]:FindFirstChild('Health') and (L_533_[3].Health.Value > 0 and (Vector3.new(-3823.9206542969, 76.979339599609, -11685.7734375) - L_533_[3].HumanoidRootPart.Position).Magnitude >= 1500) then
                                    ...
                                    until (L_533_[3].HumanoidRootPart.Position - L_1_[35].Character.HumanoidRootPart.Position).Magnitude <= 5 or not getGlobalEnv().AutoFarm
                                    repeat
                                        task.wait()
                                    ...
                                    until not L_533_[3].Parent or L_533_[3].Health.Value <= 0 or not getGlobalEnv().AutoFarm
                        ...
                        for L_537_forvar0, L_538_forvar1 in pairs(L_1_[40]:GetChildren())do
                            ...
                            if L_539_[2].Name == 'Don Swan' and L_539_[2].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_539_[2].Parent or L_539_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Don Swan')
                            end
                        end
                        ...
                        for L_540_forvar0, L_541_forvar1 in pairs(L_1_[7]:GetChildren())do
                            ...
                            if L_542_[1].Name == 'Don Swan' and L_542_[1].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_542_[1].Parent or L_542_[1].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Don Swan')
                            end
                        end
                    else
                        ...
                        for L_555_forvar0, L_556_forvar1 in pairs(L_1_[40]:GetChildren())do
                            ...
                            if L_557_[1].Name == 'Hydra Leader' and L_557_[1].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_557_[1].Parent or L_557_[1].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Hydra Leader')
                            end
                        end
                        ...
                        for L_558_forvar0, L_559_forvar1 in pairs(L_1_[7]:GetChildren())do
                            ...
                            if L_560_[2].Name == 'Hydra Leader' and L_560_[2].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_560_[2].Parent or L_560_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Hydra Leader')
                            end
                        end
                    end
                        ...
                        for L_568_forvar0, L_569_forvar1 in pairs(L_1_[40]:GetChildren())do
                            ...
                            if L_570_[2].Name == 'Longma' and L_570_[2].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_570_[2].Parent or L_570_[2].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Longma')
                            end
                        end
                        ...
                        for L_571_forvar0, L_572_forvar1 in pairs(L_1_[7]:GetChildren())do
                            ...
                            if L_573_[3].Name == 'Longma' and L_573_[3].Humanoid.Health > 0 then
                                repeat
                                    ...
                                    L_1_[14]()
                                until not L_573_[3].Parent or L_573_[3].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm or not L_1_[45].CheckBoss('Longma')
                            end
                        end
                    else
                        L_1_[45].HopLowServer(3)
                                ...
                                for L_593_forvar0, L_594_forvar1 in pairs(L_1_[40]:GetChildren())do
                                    ...
                                    if L_595_[3].Name == L_591_[1] and L_595_[3].Humanoid.Health > 0 then
                                        repeat
                                            ...
                                            L_1_[14]()
                                        until not L_595_[3].Parent or L_595_[3].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm
                                    end
                                end
                                ...
                                for L_596_forvar0, L_597_forvar1 in pairs(L_1_[7]:GetChildren())do
                                    ...
                                    if L_598_[1].Name == L_591_[1] and L_598_[1].Humanoid.Health > 0 then
                                        repeat
                                            ...
                                            L_1_[14]()
                                        until not L_598_[1].Parent or L_598_[1].Humanoid.Health <= 0 or not getGlobalEnv().AutoFarm
                                    end
                                end
                            end
                        else
    ...
    while L_1_[45].wt(1) do
        pcall(function()
            if not L_1_[45].ffc(L_1_[35].Character, 'Highlight') then
                ...
                L_646_[1].FillColor = Color3.fromRGB(255, 165, 0)
                L_646_[1].OutlineColor = Color3.fromRGB(255, 165, 0)
...
loadstring(game:HttpGet('https://raw.githubusercontent.com/Graihub/fastattackgay/refs/heads/main/3071721359096691.txt'))()
